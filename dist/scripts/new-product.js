...
let categoriesEl = document.querySelector('[data-category-select]');
let itemNameInput = document.querySelector('[data-item-name]');
let itemQuantityInput = document.querySelector('[data-item-quantity]');
let confirmBtn = document.querySelector('[data-item-confirm]');
