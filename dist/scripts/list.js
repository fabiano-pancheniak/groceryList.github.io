"use strict";
let listContainerEl = document.querySelector('[data-list-container]');
let newItemBtn = document.querySelector('[data-new-item]');
let backArrowBtn = document.querySelector('[data-back-arrow]');
...
let currentList, allLists, index;
let currentListEl = document.querySelector('[data-current-list]');
